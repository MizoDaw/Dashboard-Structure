...
export const useGetOrders=(params:any, options:any)=>useGetQuery(KEYS.ORDERS,API.GET_ORDERS,params, options);
export const useGetSingleOrder=(params:any)=>useGetQuery(KEYS.SINGLE_ORDER,API.SINGLE_ORDER,params);


export const useGetAllOrders=(params:any)=>useGetQuery(KEYS.ORDERS,API.GET_ALL_ORDERS,params,{enabled:!!params.vendor_filter});
